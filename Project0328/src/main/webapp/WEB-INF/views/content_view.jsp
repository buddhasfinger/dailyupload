    ...
    <script>
    	function replyWrite(){
    		...
    		$.ajax({
				...
				type:"get",
				data:{
					hrw_Content:$("#r_content").val(),
					hrw_User:$("#r_name").val(),
					hrw_Group:$("#r_group").val() //보내는 데이터
				},
				contentType:"application/json",
				success:function(data){  //받는 데이터
					alert("성공");
					//var txt ='호호호';
// 					var txt= "<ul><li class="name">"+data.hrw_User+ "</li>";
// 						txt= txt+ "<li class="txt">"+data.hrw_Content+"</li>";
// 						txt= txt+"<li class="btn"><a href="#" class="rebtn">수정</a><a href="#" class="rebtn">삭제</a></li></ul>";
					var rtext= "<ul><li class="+name+">"+data.hrw_User+ "</li><br>";
						rtext= rtext+ "<li>"+data.hrw_Content+ "</li>";
// 						rtext= rtext+"<li><input type="+button+" class="+rebtn+" value="+수정+">";
// 						rtext=rtext+"<input type="+button+" class="+rebtn+" value="+삭제+"></li></ul>";
						$('#replyBox').append(rtext);
// 						$('#replyBox').append(rtext);
 					},
				...
				<div id="mypage">
					...
					<div class="viewDivMt">
						<div class="viewHead">
							<div class="subject">
								<ul>
									<li>${map.boardDto.hb_Title }</li>
								</ul>
							</div>
							<div class="day">
								<p class="txt">작성자<span>${map.boardDto.hb_User }</span></p>
							</div>
						</div>
...
<!-- 							<img src="../images/img/sample_event_view.jpg" alt="" /> -->
					...
					<div class="btnArea">
						<div class="bRight">
							<ul>
								<li><a href="#" class="sbtnMini mw">수정하기</a></li>
							</ul>
						</div>
					</div>
					<div class="btnArea">
					...
					<div class="btnArea">
						<div class="bRight">
							<ul>
								<li><a href="./list" class="sbtnMini mw">목록으로</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
...
<!-- 								<p class="txt">총 <span class="orange">3</span> 개의 댓글이 달려있습니다.</p> -->
								<textarea class="replyType" name="r_content" id="r_content"></textarea>
								<input type="hidden" name="r_name" value="${session_name}" id="r_name">
								<input type="hidden" name="r_group" value="${map.boardDto.hb_Seq}" id="r_group">
							</li>
							<li class="btn"><input type="button" class="replyBtn" onclick="replyWrite()" value="등록"></li>
						</ul>
						</form>
					</div>
...
<!-- 						<ul> -->
<!-- 							<li class="name">data.hrw_User </li> -->
<!-- 							<li class="txt">data.hrw_Content</li> -->
<!-- 							<li class="btn"> -->
<!-- 								<a href="#" class="rebtn">수정</a> -->
<!-- 								<a href="#" class="rebtn">삭제</a> -->
<!-- 							</li> -->
