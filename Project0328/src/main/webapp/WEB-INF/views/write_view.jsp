...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="outbox">		
			...
			<div id="contents">
				<div id="customer">
					<h2><strong>희망도서신청서</strong><span>희망도서를 신청해 주시면, 댓글로 진행사항을 알려드립니다.</span></h2>
					
				 <form action="/write" id="writeForm"  name="write" method="post" >
					<div class="checkMt">
						<table class="checkTable" border="1" cellspacing="0">
							...
							<tbody>
								<tr>
									...
									<td>
										<input type="text" name="hb_User" value="${session_name}">
									</td>
								</tr>
								<tr>
									<th scope="row"><span>제목</span></th>
									<td>
										<input type="text" class="wlong" name="hb_Title" />
									</td>
								</tr>
								<tr>
									<th scope="row"><span>상세 내용</span></th>
									<td>
										<textarea class="tta" name="hb_Content"></textarea>
									</td>
								</tr>
							</tbody>
						</table>
					...
					<div class="btnArea">
						<div class="bCenter">
							<ul>																
								<li><input class="nbtnbig" type="reset" value="취소"></li>
								<li><input class="sbtnMini" type="submit" value="확인"></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
