...
<script>
	function dateCheck(date,roomNum) {
		alert("날짜체크중");
		alert($("#roomNum").val());
		...
		$.ajax({
			...
			traditional:true,
			data:{
				"date":$("#date").val(),"roomNum":$("#roomNum").val()
			},
			success : function(data) {
				console.log(data.rs[0]);
 				...
 				var dis_msg="";
 				var innerStr = "";
				innerStr = '<select name="dateChoice" id="dateChoice">';
   				for(var i=9;i<=18;i++){ 
		...
		<table>
			...
			<tr>
				...
				<td>
					...
					<div id="timeSelect" style="display:block;"></div>
