...
<section>
    ...
    <table>
      ...
      <tr>
        ...
        <a href="./content_view?category=${map.category}&search=${map.search}&page=${map.page}&bid=${map.nextDto.hb_Seq}">${map.nextDto.hb_Title }</a></td>
      </tr>
      <tr>
        <td colspan="3"><strong>이전글</strong> <span class="separator">|</span> 
        <a href="./content_view?category=${map.category}&search=${map.search}&bid=${map.preDto.hb_Seq }&page=${map.page}"> ${map.preDto.hb_Title }</a>
       </td>
      </tr>
    </table>
